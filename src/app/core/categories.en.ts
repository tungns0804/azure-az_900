...
export interface EnDomain {
  title: string;
  intro: string;
  /** chỉ khai báo khi tỉ trọng hiển thị khác bản tiếng Việt */
  weight?: string;
}
...
export interface EnTopic {
  title: string;
  overview: string;
  /** nhãn link, song song theo chỉ số với links trong categories.ts */
  links?: string[];
}
...
export const TOPIC_EN: Record<string, EnTopic> = {
  ...
  'cc-define': {
    links: [
      'Learning module: Describe cloud computing',
  ...
  'cc-models': {
    links: [
      'Learning module: Describe cloud service types',
      'Azure Arc overview',
    ],
  ...
  'cc-pricing': {
    links: [
      'Fiscal outcomes — CapEx and OpEx',
    ],
  ...
  'cb-ha-scale': {
    links: [
      'Reliability — Azure Well-Architected',
  ...
  'cb-manage': {
    links: [
      'Learning module: Benefits of using cloud services',
    ],
    title: 'Manageability',
    overview:
